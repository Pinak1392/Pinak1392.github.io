...
export default function Employment() {
    const jobs = [
        ...
        },
        {
            ...
            description: 'I got contracted to create visualisations of fossils and other datasets using a software called Vayu. During this time, I gained proficiency in Flask, HTML, CSS and JavaScript development. I also maintained and developed a licensing system and license management website for Vayu. This work had me design a database for licensing purposes, along with creating a server for user verification. I also created some additional anti-spoofing measures to protect against potential piracy, so that users of our product could still use it without being online. The novel method allowed users to retain access to the software for a certain amount of hours without reconnecting for verification. I also created the website for users to manage their licenses, which included features such as viewing license details, renewing licenses, and managing their account information.',
        },
        {
            id: 3,
